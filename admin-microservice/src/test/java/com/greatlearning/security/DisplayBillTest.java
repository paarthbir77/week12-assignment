...
import com.example.admin.serviceImpl.AdminServiceImpl;
...
String date, month, year;
		...
		reports.add(new FinancialReport("1", 60, date, month, year, "delhi"));
		reports.add(new FinancialReport("3", 70, date, month, year, "chennai"));
		reports.add(new FinancialReport("2", 20, date, month, year, "mumbai"));
		reports.add(new FinancialReport("4", 50, date, month, year, "delhi"));
